...
| 3/5 (목) | Session 2 — GitHub로 내 설정 관리하기 | 20:00~22:00 | 온/오프라인 | 예정 |
| 3/9 (월) | Session 3 — 업무 도구 연결 + Context Sync | 20:00~22:00 | 온/오프라인 | 예정 |
| 3/10 (화) | Session 4 — (재설계 예정) | 20:00~22:00 | 온/오프라인 | 예정 |
