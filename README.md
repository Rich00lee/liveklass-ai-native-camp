...
| 날짜 | 세션 | 시간 | 장소 | 상태 |
|------|------|------|------|------|
| 3/3 (화) | Session 1 — 설치 + 핵심 기능 체험 | 20:00~22:00 | 헤이그라운드 세미나실 | 진행 중 |
| 3/5 (목) | Session 2 — 업무 도구 연결 | 20:00~22:00 | 온/오프라인 | 예정 |
| 3/9 (월) | Session 3 — 나만의 업무 자동화 만들기 | 20:00~22:00 | 온/오프라인 | 예정 |
| 3/10 (화) | Session 4 — 자동화 고도화 + 발표 준비 | 20:00~22:00 | 온/오프라인 | 예정 |
| 3/14 (금) | Session 5 — 사내 공유 발표 | 업무시간 내 (추후 안내) | 오프라인 | 예정 |
